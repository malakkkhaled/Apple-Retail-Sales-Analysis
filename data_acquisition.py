...
class DataAcquisitionEngineer:
    ...
    def save_processed_data(self, df: DataFrame, dataset_name: str, format: str = "csv"):


     output_path = f"data/processed/{dataset_name}.csv"

     logger.info(f"Saving {dataset_name} to {output_path} using pandas")
